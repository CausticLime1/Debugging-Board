...
If you like, you could customize its resolution to drive different displays you prefer.
For a built-in 240x320 configuration, enable `USING_240X320` in `st7789.h`.
